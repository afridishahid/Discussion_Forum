            ...
            <div class="media-body">
                 <p>
                    <?php
                        ...
                        $ques=mysqli_query($conn,"SELECT qid,`question`,`date`  FROM questions where userid='".$_SESSION['username']."'");
						$q=mysqli_fetch_array($ques);
						$qid=$q['qid'];
						$qid2=(int)$qid;
						/*echo (int)$qid; */
						 if($qid2==0) 
                        ...
                        while($q=mysqli_fetch_array($ques))
                        {
                            ...
                            print ("Question: <i>".$q['question']."</i><br/><a class='button' href='deleteques.php?qid=$qid'>Delete</a>");
