...
<body>
    ...
    <div>
        <div class="container text-center">
            <h2 class="mt-5 text-dark font-weight-dark">Report</h2>

            <form method="post" action="post_rep.php">
                <div class="form-group">
                    <input type="hidden" name="uid" value="$_SESSION['$name']">
                    <textarea name="rep" class="form-control" rows="3" required
                        placeholder="Reason for report"></textarea>
                </div>
                <button type="submit" class="btn btn-primary">Report Abuse</button><br>
            </form>
        </div>
